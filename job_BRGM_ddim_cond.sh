...
#SBATCH --output=InverseSR_1ch_crossattn_new%j.out
#SBATCH --error=InverseSR_1ch_crossattn_new%j.err
...
python3 $SCRATCH/InverseSr-Astro/project/BRGM_ddim_cond_v2.py \
