...
#SBATCH --output=ddpmv3_100_concat%j.out           # File dove finiranno i print dello script
#SBATCH --error=ddpmv3_100_concat%j.err
...
# Lancio del training
python project/ml_flow_train_ddpm_v3.py  --cond_key "concat" --data_dir "./data/inputs/128x128x128_stride128/npy_patches" --catalogue_path "./data/inputs/128x128x128_stride128/train_catalog.csv" --output_dir "./data/outputs/ddpm_concat_100_2" --epochs 100 --batch_size 2 --vae_path "./data/trained_models_astro_400/vae_full_ep400.pth"  --in_channels_unet 7
