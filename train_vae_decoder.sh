...
#SBATCH --output=vae_decoder_global_sym_new%j.out
#SBATCH --error=vae_decoder_global_sym_new%j.err
...
python ${BASE_DIR}/project/ml_flow_train_vae_decoder.py \
    ...
    --tensor_board_logger_vae "./logs_vae/global_sym_vae_decoder_${EPOCHS}ep_z${Z_CHANNELS}"
