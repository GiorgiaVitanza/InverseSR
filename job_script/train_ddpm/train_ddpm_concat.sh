...
python3 ${SCRATCH}/project/ml_flow_train_ddpm_v3.py\
    ...
    --tensor_board_logger_ddpm "${SCRATCH}/logs_ddpm/ddpm_${COND}_${EPOCHS}_z${Z_CHANNELS}_${NORM_MODE}_cont_Dev_x0"\
    --output_dir_ddpm "${SCRATCH}/data/trained_models_astro/ddpm_${COND}_${EPOCHS}_z${Z_CHANNELS}_${NORM_MODE}_cont_dev_x0"\
    --epochs $EPOCHS\
