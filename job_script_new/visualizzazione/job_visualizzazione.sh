#!/bin/bash
#SBATCH --job-name=vis_data          # Nome del job
#SBATCH --output=vis_input_%j.out      # File di log (assicurati che la cartella 'logs' esista)
#SBATCH --error=vis_input_%j.err       # File di errore
...
python3 /leonardo_scratch/large/userexternal/gvitanza/InverseSR/project/visualizzazione_3d.py 